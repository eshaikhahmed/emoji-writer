...
<head>
    ...
    <meta name="keywords" content="writein linkedIn writer,writein linkedIn emoji writer,writein emoji online, linkedin writer online,linkedin writer emoji online, twitter writer with emoji online, writer emoji, factance linkedin emoji writer, twitter writer emoji, twiter post writer emoji">
    <meta name="description" content="WriteIn - A tool to write clean and awesome post with emojis">
    <title><?=$title?></title>
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top" 
    ...
    font-size: 30px;">
              ...
              <span >
              <span style="color:#007ACC;">Write</span>In
              </span>
